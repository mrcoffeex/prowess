                        ...
                        <div class="card mb-4">
                            ...
                            <form id="formValidation" class="card-body" enctype="multipart/form-data" method="POST" action="fillupformCreate">
                                ...
                                <div class="row g-3">
                                    ...
                                    <hr class="my-4 mx-n4" />
                                    <h5><i class="mdi mdi-star-settings-outline me-2 mdi-20px"></i>Skills Information</h5>
                                    <div class="col-md-4 select2-primary">
                                        <div class="form-floating form-floating-outline">
                                            <select id="scholarTechskills" name="scholarTechskills[]" class="select2 form-select" multiple>
                                                <option></option>
                                            ...
                                            <label for="scholarTechskills">Technical Skills (You can select multiple)</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4 select2-primary">
                                        <div class="form-floating form-floating-outline">
                                            <select id="scholarSoftskills" name="scholarSoftskills[]" class="select2 form-select" multiple>
                                                <option></option>
                                            ...
                                            <label for="scholarSoftskills">Soft Skills (You can select multiple)</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4 select2-primary">
                                        <div class="form-floating form-floating-outline">
                                            <select id="scholarIndskills" name="scholarIndskills[]" class="select2 form-select" multiple>
                                                <option></option>
                                            ...
                                            <label for="scholarIndskills">Industrial Skills (You can select multiple)</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4 select2-primary">
                                        <div class="form-floating form-floating-outline">
                                            <select id="scholarVocskills" name="scholarVocskills[]" class="select2 form-select" multiple>
                                                <option></option>

                                                <optgroup label="Wielding and Metalwork">
                                                    <option value="Arc Wielding">Arc Wielding</option>
                                                    <option value="Gas welding">Gas welding</option>
                                                </optgroup>

                                            </select>
                                            <label for="scholarVocskills">Vocational Skills (You can select multiple)</label>
                                        </div>
                                    </div>
                                </div>
                                <hr class="my-4 mx-n4" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating form-floating-outline">
                                            <select id="scholarIncome" name="scholarIncome" class="form-control">
                                                <option>Select Household Monthly Income</option>
