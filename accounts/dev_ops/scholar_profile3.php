                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="nav nav-pills flex-column flex-sm-row mb-4">
                                ...
                                <li class="nav-item">
                                <a class="nav-link active" href="scholar_profile3?rand=<?= my_rand_str(100) ?>&scholarCode=<?= $scholarCode ?>"
                        ...
                        <div class="col-lg-12">
                            <div class="card card-action mb-4">
                                ...
                                <div class="card-body pt-3 pb-0">
                                    <form action="scholar_profile3?rand=<?= my_rand_str(100) ?>&scholarCode=<?= $scholarCode ?>" enctype="multipart/form-data" method="post" onsubmit="this.showGrades">
                                    <div class="row">
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <a href="scholarReportCard?scholarCode=<?= $scholarCode ?>" target="_blank">
