        ...
        <div class="modal fade" id="addSubject" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="hei_subject_create?rand=<?= my_rand_str(100) ?>&hei_id=<?= $hei_id ?>&course_id=<?= $course_id ?>" enctype="multipart/form-data" method="POST" onsubmit="btnLoader(this.createSubjectBtn)">
                            <div class="row">
                                <div class="col-sm-6 mb-3">
                                    <div class="form-floating form-floating-outline">
