          ...
          <div class="content-wrapper">
            <?php include "_topnavigation.php"; ?>
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card">
                            <h5 class="card-header"> <span><a href="settings">Settings</a></span> / Course List</h5>
                            <div class="card-body">
                                                        ...
                                                        <form action="hei_information_create" method="POST">
                                                            <div class="col-sm-12 mt-3 mb-4">
                                                                <div class="form-floating form-floating-outline">
                                                                    <input type="text" name="courseName" id="courseName" class="form-control" placeholder="Enter Name" />
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" id="courseBtn" name="heiSavecourseBtnBtn" class="btn btn-primary">Save Course</button>
                                                            </div>
                                                        </form>
                                                    </div>
