                          ...
                          <div class="user-profile-info">
                            ...
                            <ul
                              ...
                              <li class="list-inline-item">
                                ...
                                ><span class="fw-semibold"><?= $userFullname ?></span>
                              </li>
                              <li class="list-inline-item">
                  ...
                  <div class="card mb-4">
                    <div class="card-body">
                      ...
                      <ul class="list-unstyled mb-0 mt-3 pt-1">
                        ...
                        <li class="d-flex align-items-center mb-3">
                          <i class="mdi mdi-account-outline mdi-24px"></i
                          ><span class="fw-semibold mx-2">Projects Compiled:</span> <span>146</span>
                        </li>
                        <li class="d-flex align-items-center">
                          <i class="mdi mdi-view-grid-outline mdi-24px"></i
                          ><span class="fw-semibold mx-2">Connections:</span> <span>897</span>
                        </li>
                      </ul>
                    </div>
                  </div>
