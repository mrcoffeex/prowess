                ...
                <div class="card">
                  <div class="d-flex align-items-end row">
                    <div class="col-md-8 order-2 order-md-1">
                      <div class="card-body">
                        <h4 class="card-title mb-0" id="userName" name="userName">Welcome <strong>Industry Name</strong></h4>
                    ...
                    <div class="d-flex align-items-center flex-wrap gap-2">
                      <div class="avatar me-3">
                        <div class="avatar-initial bg-label-primary rounded">
                          <i class="mdi mdi-24px mdi-briefcase-outline text-success"> </i>
                        </div>
                      </div>
                      <div class="card-info">
                        ...
                        <small class="text-muted">No. of Jobs</small>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center flex-wrap gap-2">
                      <div class="avatar me-3">
                        <div class="avatar-initial bg-label-primary rounded">
                          <i class="mdi mdi-24px mdi-account-search-outline text-primary"> </i>
                        </div>
                      </div>
                      <div class="card-info">
                        <div class="d-flex align-items-center">
                        ...
                        <small class="text-muted">No. of Applications</small>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center flex-wrap gap-2">
                      <div class="avatar me-3">
                        <div class="avatar-initial bg-label-primary rounded">
                          <i class="mdi mdi-24px mdi-star-outline text-warning"> </i>
                        </div>
                      </div>
                      <div class="card-info">
                        <div class="d-flex align-items-center">
                        ...
                        <small class="text-muted">Industry Ratings</small>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center flex-wrap gap-2">
                      ...
                      <div class="card-info">
                        ...
                        <small class="text-muted">Percentage of Funded Scholar</small>
                      </div>
                    </div>
                  </div>
                </div>
