<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      <a href="heiProfile" class="menu-link">
        <i class="menu-icon tf-icons mdi mdi-account-outline"></i>
        <div data-i18n="HEI Profile">HEI Profile</div>
      </a>
    </li>
    ...
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <div data-i18n="Scholar Information">Scholar Information</div>
      </a>

      <ul class="menu-sub">
        <li class="menu-item">
          <a href="scholarList" class="menu-link">
            <div data-i18n="Scholar List">Scholar List</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="scholarListPending" class="menu-link">
            <div data-i18n="Pending Scholar">Pending Scholar</div>
            <div class="badge bg-primary rounded-pill ms-auto"><?= countHeiScholarPending($heiId) ?></div>
          </a>
        </li>
      </ul>
    </li>
    ...
    <li class="menu-item">
      <a href="_support" class="menu-link">
        <i class="menu-icon tf-icons mdi mdi-lifebuoy"></i>
        <div data-i18n="Support">Support</div>
      </a>
    </li>
    <li class="menu-item">
      <a href="_about" class="menu-link">
