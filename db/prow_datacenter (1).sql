...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 19, 2023 at 07:09 AM
...
(1, '2023UTUIrT', '0', '', 'Delima', 'Joane May', 'Cortes', '', 'Female', 'Single', '1994-02-06', 'Valenzuela Metro Manila', '9282657552', 'joanemaydelima@gmail.com', 2, 0, '2023-11-17 16:06:12', '2023-11-17 16:06:12');
...
(1, '2023UTUIrT', 'Datoc Compound, Digos City', 'Zone 1', 'Digos City', 'Davao del Sur', 8002, '2023-11-17 16:06:12', '2023-11-17 16:06:12');
...
(4, '20231118080612pVj2qXKtmC', '2023UTUIrT', 'Joane May Delima', 'annimay', '1bbd886460827015e5d605ed44252251', '', 4, 0, 1, '', '2023-11-17 16:06:12', '2023-11-17 16:06:12');
...
--
ALTER TABLE `prow_hei_subjects`
  MODIFY `prow_subject_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `prow_users`
  MODIFY `prow_user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
